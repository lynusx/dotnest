...
class _LinkRewritePageContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          SizedBox(width: 320.w, child: const _ConfigPanel()),
        ...
        children: [
          ...
          SegmentedButton<RewriteOutputMode>(
            segments: [
              ButtonSegment(
                ...
                label: Text('原地覆盖', style: TextStyle(fontSize: 12.sp)),
                icon: Icon(Icons.edit_note_rounded, size: 15.sp),
              ),
              ButtonSegment(
                value: RewriteOutputMode.newDirectory,
                label: Text('输出到新目录', style: TextStyle(fontSize: 12.sp)),
                icon: Icon(Icons.drive_folder_upload_outlined, size: 15.sp),
              ),
            ],
            selected: {vm.mode},
          ...
          if (vm.mode == RewriteOutputMode.newDirectory) ...[
            ...
            _PickerField(
              ...
              onTap: () =>
                  context.read<LinkRewriteViewModel>().pickOutputDir(),
            ),
          ],
